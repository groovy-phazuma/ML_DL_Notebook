...
Forward stepwise with monitoring AIC or BIC
A method that starts with a model that does not include explanatory variables and increases variables one by one.

References
- https://mimikousi.com/forward-stepwise-regression/
...
def forward_stepwise(x, y, method='BIC',verbose=False):
    """
    Args:
    ...
    beta = forward_stepwise_result(x_tmp[:, included], y)
